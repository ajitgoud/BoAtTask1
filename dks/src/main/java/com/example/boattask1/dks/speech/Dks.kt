package com.example.boattask1.dks.speech
...
import com.example.boattask1.dks.language.DksLanguageListener
import com.example.boattask1.dks.language.DksLanguageReceiver
import com.example.boattask1.dks.utils.isNetworkAvailable
import com.example.boattask1.dks.utils.parseSpeechResult
import com.example.boattask1.dks.view.alert.DksFullScreenDialog
import com.example.boattask1.dks.view.alert.DksFullScreenDialogListener
import com.example.boattask1.dks.view.alert.DksLiveObservers
...
class Dks(private val app: Application, private val manager: FragmentManager?, private val listener: DksListener): DksEngine() {
    ...
    override var languageDetailsIntent: Intent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH) //RecognizerIntent.getVoiceDetailsIntent(app)
    ...
    init {
        ...
        app.sendOrderedBroadcast(languageDetailsIntent, null, DksLanguageReceiver(object:
            DksLanguageListener {
    ...
    override fun triggerProgressView(progressViewLayout: Int) {
        ...
        manager?.beginTransaction()?.add(DksFullScreenDialog(progressViewLayout, manager, observers, object:
            DksFullScreenDialogListener {
