package com.example.boattask1.dks.view.alert
...
import com.example.boattask1.dks.view.progress.DksProgressView
import com.example.boattask1.dks.view.progress.DksProgressViewListener
...
//        val dialogView =  LayoutProgressViewBinding.inflate(inflater,container, false)
       if (dialogView is DksProgressView) {
//            val customTextView=dialogView.findViewById<TextView>(R.id.tv_progress_message)
//            val defaultProgressTxt = customTextView.text.toString()
